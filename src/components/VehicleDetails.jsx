...
export default function VehicleDetails({ vehicle, onInspect, onPrice, onOffer, onSell }) {
  ...
  return <section className="panel detail-panel">
    ...
    {vehicle.listPrice && <div className="sale-actions"><button className="button button-accent" type="button" onClick={() => onOffer(vehicle.id)}>Find a customer</button><button className="button button-secondary" type="button" onClick={() => onSell(vehicle.id)}>Sell now</button></div>}
  </section>
}